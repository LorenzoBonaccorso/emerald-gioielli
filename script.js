...
const INTERVALLO_CAMBIO_STATICO_MS = 10 * 60 * 1000;
...
async function caricaMercatoDaTickBaseStatico() {
 ...
 // Il file JSON contiene soprattutto il cambio USD/EUR TickBase, rigenerato da GitHub Actions ogni 10 minuti.
